...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[20,50,100,500],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_d1,_d2){
...
var prow=$.easyui.getArrayItem(_941.checkedRows,opts.idField,row.parentId);
