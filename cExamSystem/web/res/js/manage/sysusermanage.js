 ...
 */
var moduleType = GetQueryString("moduleType");//新闻所属模块的ID
...
function Add(){
    ...
    postURL = "/AdminLogin/AddSysUser.form";
    $("#Form").form("clear");
    $("#dlg").dialog({title: "新建"});
    $('#dlg').dialog('open');
}
...
function Edit(){
    ...
    postURL = "/jsons/AdmineditSysUser.form";
...
//删除
function Delete(){
    postURL = "/jsons/AdmindeleteSysUser.form";
    var row = $('#dg').datagrid('getSelected');
    if (row){
