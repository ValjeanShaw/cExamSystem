...
<%--数据表格--%>
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:530px;max-height: 100%;"
       data-options="pagination:true,
                   ...
                   url:'<%=request.getContextPath()%>/Items/AdminList.port'">
    <thead>
    <tr>
        <%-- 3、第三处修改，修改此处的列名称，与数据库一致，显示有必要的（跨行的字符串不要显示）--%>
        <th field="id" width="100px" >ID</th>
        <th field="title" width="100px">商品名称</th>
        <th field="price" width="100px">单价（分）</th>
        <th field="num" width="100px">数量</th>
        <th field="sell_point" width="100px" hidden>卖点</th>
        <th field="barcode" width="100px" hidden>二维码</th>
        <th field="image" width="100px" hidden>图片</th>
        <th field="cid" width="100px" hidden>所属类目</th>
        <th field="createdate" width="100px" >创建时间</th>
        <th field="updated" width="100px" >更新时间</th>
    </tr>
    </thead>
</table>
<%--表格头部按钮--%>
<div id="tb" style="height:auto">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="Addn()">新建</a>
